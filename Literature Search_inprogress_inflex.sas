...
/* Metabolic inflexibility + combined set */

data ref2.comb_inflex ref2.other_inflex;
	set ref2.combined;
	if find(Research_Gaps, 'metabolic inflexibility', 'I')>0 then output ref2.comb_inflex; 
	
	else output ref2.other_inflex;
run;

title1 'combined set + metabolic inflexibility';

proc print data=ref2.comb_inflex;			
run;
...
/* Metabolic inflexibility + Ceramide */

data ref2.cer_inflex ref2.other_inflex;
	set ref2.ceramide_sphingo;
	if find(Research_Gaps, 'metabolic inflexibility', 'I')>0 then output ref2.cer_inflex; 
	
	else output ref2.other_inflex;
run;

title1 'Ceramides / Sphingolipids + metabolic inflexibility';

proc print data=ref2.cer_inflex;			
run;
...
/* Metabolic inflexibility + Acylcarnitine */

data ref2.carn_inflex ref2.other_inflex;
	set ref2.Acylcarnitine;
	if find(Research_Gaps, 'metabolic inflexibility', 'I')>0 then output ref2.carn_inflex; 
	
	else output ref2.other_inflex;
run;

title1 'Acylcarnitine + metabolic inflexibility';

proc print data=ref2.carn_inflex;			
run;
